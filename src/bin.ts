...
program
  ...
  .option('--json', 'Output JSON result')
  .option('--api-url <url>', 'Ramp API base URL')
  .action(async (options: { stack?: string; json?: boolean; apiUrl?: string }) => {
...
program
  ...
  .option('--server <name>', 'Filter by server name when multiple matches exist')
  .option('--json', 'Output JSON result')
  .option('--api-url <url>', 'Ramp API base URL')
  .action(async (options: { app?: string; server?: string; json?: boolean; apiUrl?: string }) => {
...
program
  .command('rollback')
  .description('Rollback app to latest successful deploy or specific deploy id')
  .helpGroup('Project workflow:')
  .option('--app <stack>', 'Override stack name')
  .option('--server <name>', 'Filter by server name')
...
program
  ...
  .option('--api-url <url>', 'Ramp API base URL')
  .action(async (options: { json?: boolean; showToken?: boolean; apiUrl?: string }) => {
...
program
  ...
  .option('--api-url <url>', 'Ramp API base URL')
  .action(
    async (options: { app?: string; server?: string; identity?: string; apiUrl?: string }) => {
