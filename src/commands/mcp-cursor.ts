...
export async function runMcpCursorCommand(
    options: McpCursorCommandOptions,
): Promise<number> {
    ...
    process.stdout.write(
        `${box([
            statusLine('success', `Cursor MCP snippet for ${paint(connection.email ?? 'current account', 'bold')}`),
