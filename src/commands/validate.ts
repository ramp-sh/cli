...
import { appHeader, box, isInteractiveUi, keyHint, kvTable, paint, statusLine } from '../lib/ui.js';
...
function outputResult(result: ValidationResult, options: ValidateCommandOptions): number {
...
async function runRemoteValidation(
  ...
  try {
    ...
    const result: ValidationResult = {
      ...
      errors: Array.isArray(json.errors) ? (json.errors as ValidationError[]) : [],
      warnings: Array.isArray(json.warnings) ? (json.warnings as ValidationError[]) : [],
    };
